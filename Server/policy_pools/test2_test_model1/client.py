...
if __name__ == "__main__":
    ...
    push_folder("/home/mhm/workspace/Competition_TaxingAI/TaxAI_3rd_version/agents/model_self", user_id=USER_ID, model_id="test_model1", algo_name="test_algo", epoch=0)
