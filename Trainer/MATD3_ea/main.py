...
def parse_args():
    ...
    parser.add_argument('--load_new', type=int, default=10, help='load new others')
    parser.add_argument('--pop_id', type=int, default=0, help='population id')
    parser.add_argument('--gamma', type=float, default=0.975, help='gamma')
    parser.add_argument('--gini_weight', type=float, default=1.0, help='gamma')
...
if __name__ == '__main__':
    ...
    yaml_cfg.seed = args.seed + args.pop_id
    ...
    args.eval_episodes = 1 #yaml_cfg.Trainer['eval_episodes']
