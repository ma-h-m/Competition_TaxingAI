...
def fetch_random_models(num_models, user_id=USER_ID, dest_dir="TaxAI_modified/agents/model_pools/models_from_server"):
    ...
    client_socket.send(f"FETCH_RANDOM_MODELS{SEPARATOR}{num_models}{SEPARATOR}{USER_ID}{SEPARATOR}".encode())
